...
const PinModal = ({ isOpen, onClose, onSavePin }) => {
  ...
  return (
    <div className={`fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center ${isOpen ? "" : "hidden"}`}>
      ...
      <div className="modal-content bg-white p-4 rounded-md shadow-lg relative z-20 w-3/5 h-2/5">
        ...
        <form onSubmit={handleSavePin}>          
          ...
          <div className="flex justify-end">
            <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Save PIN</button>
          </div>
        </form>
      </div>
    </div>
