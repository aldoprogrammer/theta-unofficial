function UploadWithoutURL() {
    return (
      <div>
        <div class=" flex flex-col justify-center items-center p-4  text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
          <h4 class="block font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
            Upload videos You love
          </h4>
  ...
  export default UploadWithoutURL;
